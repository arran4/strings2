...
func (c *RootCmd) NewWordstodarwin() *Wordstodarwin {
	...
	v.CommandAction = func(c *Wordstodarwin) error {
		...
		cli.WordsToDarwin(c.input, c.output, c.jsonInput, c.delimiter, c.screaming, c.whispering, c.firstUpper, c.firstLower, c.delimiters, c.delimitersFunc, c.strict, c.args...)
		return nil
	}

...
func (c *RootCmd) NewScreamingsnake() *Screamingsnake {
	...
	v.CommandAction = func(c *Screamingsnake) error {
		...
		cli.ScreamingSnake(c.input, c.output, c.delimiter, c.screaming, c.whispering, c.firstUpper, c.firstLower, c.mixCaseSupport, c.noSmartAcronyms, c.numberSplitting, c.nonAlphanumeric, c.delimiterDetector, c.acronym, c.acronymFromFile, c.strict, c.args...)
		return nil
	}

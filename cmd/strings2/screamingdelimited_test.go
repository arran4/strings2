...
func TestScreamingdelimited_Execute(t *testing.T) {

	parent := &RootCmd{
		FlagSet:  flag.NewFlagSet("root", flag.ContinueOnError),
		Commands: make(map[string]func() Cmd),
	}
	cmd := parent.NewScreamingdelimited()

	called := false
	cmd.CommandAction = func(c *Screamingdelimited) error {
		called = true
		return nil
	}
...
func TestScreamingdelimited_ExecuteHelpAndUnknownFlags(t *testing.T) {

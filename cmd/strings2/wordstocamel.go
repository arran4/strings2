...
func (c *RootCmd) NewWordstocamel() *Wordstocamel {
	...
	v.CommandAction = func(c *Wordstocamel) error {
		...
		cli.WordsToCamel(c.input, c.output, c.jsonInput, c.delimiter, c.screaming, c.whispering, c.firstUpper, c.firstLower, c.nonAlphanumeric, c.delimiters, c.strict, c.args...)
		return nil
	}

...
func (c *Wordstotitle) Usage() {
	err := executeUsage(os.Stderr, "wordstotitle_usage.txt", UsageDataWordstotitle{c, false})
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error generating usage: %s\n", err)
	}
}

func (c *Wordstotitle) UsageRecursive() {
	err := executeUsage(os.Stderr, "wordstotitle_usage.txt", UsageDataWordstotitle{c, true})
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error generating usage: %s\n", err)
	}
}

func (c *Wordstotitle) Execute(args []string) error {
	...
	if c.CommandAction != nil {
		if err := c.CommandAction(c); err != nil {
			return fmt.Errorf("wordstotitle failed: %w", err)
		}
	} else {
		c.Usage()
	}
...
func (c *RootCmd) NewWordstotitle() *Wordstotitle {
	set := flag.NewFlagSet("wordstotitle", flag.ContinueOnError)
	v := &Wordstotitle{
		RootCmd:     c,
		Flags:       set,

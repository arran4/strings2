...
func (c *RootCmd) NewWordstosnake() *Wordstosnake {
	...
	v.CommandAction = func(c *Wordstosnake) error {
		...
		cli.WordsToSnake(c.input, c.output, c.jsonInput, c.delimiter, c.screaming, c.whispering, c.firstUpper, c.firstLower, c.nonAlphanumeric, c.delimiters, c.delimitersFunc, c.strict, c.args...)
		return nil
	}

...
func (c *RootCmd) NewKebab() *Kebab {
	...
	v.CommandAction = func(c *Kebab) error {
		...
		cli.Kebab(c.input, c.output, c.delimiter, c.screaming, c.whispering, c.firstUpper, c.firstLower, c.mixCaseSupport, c.noSmartAcronyms, c.numberSplitting, c.nonAlphanumeric, c.delimiters, c.acronym, c.acronymFromFile, c.strict, c.args...)
		return nil
	}

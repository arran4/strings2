...
func (c *RootCmd) NewDarwin() *Darwin {
	...
	v.CommandAction = func(c *Darwin) error {
		...
		cli.Darwin(c.input, c.output, c.delimiter, c.screaming, c.whispering, c.firstUpper, c.firstLower, c.mixCaseSupport, c.noSmartAcronyms, c.numberSplitting, c.nonAlphanumeric, c.delimiterDetector, c.acronym, c.acronymFromFile, c.strict, c.args...)
		return nil
	}

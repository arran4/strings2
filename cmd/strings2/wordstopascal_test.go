...
func TestWordstopascal_Execute(t *testing.T) {

	parent := &RootCmd{
		FlagSet:  flag.NewFlagSet("root", flag.ContinueOnError),
		Commands: make(map[string]func() Cmd),
	}
	cmd := parent.NewWordstopascal()

	called := false
	cmd.CommandAction = func(c *Wordstopascal) error {
		called = true
		return nil
	}
...
func TestWordstopascal_ExecuteHelpAndUnknownFlags(t *testing.T) {

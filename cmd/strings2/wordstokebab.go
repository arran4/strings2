...
func (c *RootCmd) NewWordstokebab() *Wordstokebab {
	...
	v.CommandAction = func(c *Wordstokebab) error {
		...
		cli.WordsToKebab(c.input, c.output, c.jsonInput, c.delimiter, c.screaming, c.whispering, c.firstUpper, c.firstLower, c.nonAlphanumeric, c.delimiterDetector, c.strict, c.args...)
		return nil
	}
